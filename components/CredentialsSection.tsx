    ...
    <section id="credentials" className="px-5 py-16 sm:px-10 sm:py-20 sm:pb-24 border-t border-border">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-10 sm:mb-12">
          ...
          <div className="glass inline-flex shrink-0 items-center gap-1 rounded-full p-1.5 sm:p-2 pr-3 sm:pr-3 overflow-x-auto no-scrollbar max-w-full">
            <button
              onClick={() => handleTabChange("education")}
              className={`relative flex shrink-0 items-center gap-2 rounded-full px-3.5 py-1.5 sm:px-4 sm:py-2 text-xs font-mono transition-colors ${
                activeTab === "education"
